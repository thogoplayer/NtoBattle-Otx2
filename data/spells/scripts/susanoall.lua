...
status = {
    [1] = {skills = {{C_NINJUTSU, 10}, {C_DISTANCE, 10}}, health = 0, speed = 0, str = "Mangekyou Sharingan:Susanoo"},
    [2] = {skills = {{C_NINJUTSU, 18}, {C_DISTANCE, 18}}, health = 0, speed = 0, str = "Mangekyou Sharingan:Perfect Susanoo"}
	}
