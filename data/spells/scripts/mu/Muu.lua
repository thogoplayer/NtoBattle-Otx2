...
local effect = {277}   -- efeito que fica durante o uso
local effect2 = 298 -- efeito que dará ao iniciar
local ml = 13 -- quantos ira aumentar o skill de ML
local skilldistance = 0 -- quantos ira aumentar o skill de distance
local skillsword = 0 -- quantos ira aumentar o skill de sword
local skillglove = 10 -- quantos ira aumentar o skill de Glove
